...
const ChatHeader = () => {
  ...
  return (
    <>
    <header className='flex items-center gap-4 bg-white text-black px-4 border-b border-[#eee] border-solid'>
        <div className='border-r border-[#ddd] text-[#6d6d6d] flex items-center pr-4 py-5'>
          <IoIosChatbubbles size={25} />
        </div>
        <ul className='flex items-center gap-3'>
          <li className='bg-[#eee] text-[#6d6d6d] p-4 rounded-[50%] cursor-pointer' onClick={ () => dispatch( setChatTab(1) ) }><FaUser /></li>
          <li className='bg-[#eee] text-[#6d6d6d] p-4 rounded-[50%] cursor-pointer' onClick={ () => dispatch( setChatTab(2) ) }><FaUserGroup /></li>
          <li className='bg-[#eee] text-[#6d6d6d] p-4 rounded-[50%] cursor-pointer' onClick={ () => dispatch( setChatTab(3) ) }><FaShop /></li>
          <li className='bg-[#eee] text-[#6d6d6d] p-4 rounded-[50%] cursor-pointer' onClick={ () => dispatch( setChatTab(4) ) }><PiBagSimpleFill /></li>
          <li className='bg-[#eee] text-[#6d6d6d] p-4 rounded-[50%] cursor-pointer' onClick={ () => dispatch( setChatTab(5) ) }><FaHeart /></li>
        </ul>
