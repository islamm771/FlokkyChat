...
import { FaArrowsAltH, FaInfo, FaPlus, FaUserCog, FaVideo } from "react-icons/fa";
import { toggleChatList , toggleNewChat, toggleProfile , toggleReport, toggleVideoCall} from "../../../../app/feature/ListChatSlice";
import {
  FaBell,
  FaFlag,
  FaCommentSlash,
      ...
      <div className="header-mainChat">
        <div className="right-main-chat">
          ...
          <div className="user-info-main-chat">
            <p className="name">Battlefield 4</p>
            <p className="nickname">#bf4</p>
          </div>
