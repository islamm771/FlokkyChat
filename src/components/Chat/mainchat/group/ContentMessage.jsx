...
const ContentMessage = () => {
  ...
  const { isVideoStream, isProfile, isOpenChatList, isForward } =
  ...
  const { isModelMainChat } = useSelector(selectGlobal);
  ...
  const handleToggleReactPeopleInfo = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        (reactionsRef.current && !reactionsRef.current.contains(event.target)) ||
        (actionsRefList.current && !actionsRefList.current.contains(event.target))
      ) {
        setActiveIndex(null);
        setIsReactions(false);
        setActiveIndexReact(null);
      }
    };
  ...
  }, [reactionsRef, actionsRefList, setIsReactions, setActiveIndex]);
      ...
      <div className="wrap-Message">
        ...
        <div className="messages">
          {messages.map((data, index) => (
            <div
              className={`${
                data.sendme ? "wrap-messga-select-from " : `disactive-chat`
              }
                    ...
                    >
                      ...
                      {data.liked && (
                        <div
                          ...
                          onClick={handleToggleReactPeopleInfo}
                        >
                          <div className="react">
                            <img src={like} alt="" />
                          </div>
