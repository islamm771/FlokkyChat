...
import Background from "./MessageOptions/Background";
...
const CreateMessageOptions = () => {
  ...
  return (
    <div
      className={`OverLay_createMessageOptions ${isCreateMessageOptionsModel
    ...
    >
      <div className="createMessageModel">
        ...
        {createMessageOptions == "background" ? 
          <Background activeBg={activeBg} setActiveBg={setActiveBg} val={bgText} setValue={setBgText} /> : (
          <>
            ...
            <div className="content-buttons-options-message">
              ...
              {createMessageOptions == "record" && <RecordVoice
              recordBlobLink={recordBlobLink} setRecordBlobLink={setRecordBlobLink}
              ...
              {createMessageOptions == "normal" && (
                <div className="images-actions-main-chat-message">
                  ...
                  <div className="icons-actions-main-chat icons-actions-main-chat-bg flex-icons-action-chat"
                    onClick={() => dispatch(setCreateMessageOptions("background"))}
                  >
                    <div className="wrapp-img-create-message bg-message-special-chat">
                      <img src={bg} alt="" />
                    </div>
                  ...
                  <div className="icons-actions-main-chat icons-actions-main-chat-mic flex-icons-action-chat"
                    onClick={() => dispatch(setCreateMessageOptions("record"))}>
                    <div className="wrapp-img-create-message bg-message-special-chat">
                      <svg
